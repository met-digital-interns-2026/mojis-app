...
INSERT INTO artworks (id, title, artist, year, image, medium, department, gallery, fact) VALUES
  ...
  ('45434',
   ...
   'Katsushika Hokusai',
   'ca. 1830–32',
   'https://images.metmuseum.org/CRDImages/as/web-large/DP141139.jpg',
  ...
  ('544',
   ...
   'Unknown',
   'ca. 1479–1458 B.C.',
   'https://images.metmuseum.org/CRDImages/eg/web-large/DP246556.jpg',
   'Granite, paint',
   'Egyptian Art',
   'Gallery 115',
  ...
  ('11417',
   ...
   'Emanuel Leutze',
   '1851',
   'https://images.metmuseum.org/CRDImages/ap/web-large/DT100.jpg',
   'Oil on canvas',
   'The American Wing',
   'Gallery 760',
  ...
  ('11507',
   ...
   'Albert Bierstadt',
   '1863',
   'https://images.metmuseum.org/CRDImages/ap/web-large/DT160.jpg',
   'Oil on canvas',
   'The American Wing',
   'Gallery 760',
  ...
  ('10159',
   ...
   '1845',
   'https://images.metmuseum.org/CRDImages/ap/web-large/DT68.jpg',
   'Oil on canvas',
   'The American Wing',
   'Gallery 759',
  ...
  ('10814',
   ...
   '1859',
   'https://images.metmuseum.org/CRDImages/ap/web-large/DT51.jpg',
   'Oil on canvas',
   'The American Wing',
   'Gallery 760',
  ...
  ('11189',
   ...
   'Winslow Homer',
   '1865',
   'https://images.metmuseum.org/CRDImages/ap/web-large/DT1880.jpg',
   'Oil on canvas',
   'The American Wing',
   'Gallery 764',
