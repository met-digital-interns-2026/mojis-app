...
const EMOJI_CATEGORIES = {
  sad:        { label: "Sad",         color: "#4A6FA5", levels: ["😕","🙁","☹️","😞","😢","😭"] },
  disgusted:  { label: "Disgusted",   color: "#7CB342", levels: ["😐","😒","🤢","🤮","💀","☠️"] },
...
const RELATED_ARTWORKS = [
  { title: "The Rocky Mountains, Lander's Peak", artist: "Albert Bierstadt", year: "1863", image: "https://images.metmuseum.org/CRDImages/ap/original/DT160.jpg", topEmoji: "😍", reactions: 1847 },
  { title: "Fur Traders Descending the Missouri", artist: "George Caleb Bingham", year: "1845", image: "https://images.metmuseum.org/CRDImages/ap/original/DT68.jpg", topEmoji: "❤️", reactions: 923 },
  { title: "Heart of the Andes", artist: "Frederic Edwin Church", year: "1859", image: "https://images.metmuseum.org/CRDImages/ap/original/DT51.jpg", topEmoji: "😮", reactions: 2105 },
  { title: "The Veteran in a New Field", artist: "Winslow Homer", year: "1865", image: "https://images.metmuseum.org/CRDImages/ap/original/DT1880.jpg", topEmoji: "🤔", reactions: 654 },
];
        ...
        <>
          {localReplies.length > 1 && !showReplies && (
            <button onClick={() => setShowReplies(true)} style={{
              ...
              padding: "4px 0 0 40px", fontFamily: "'DM Sans', sans-serif",
            }}>
...
export default function ArtDetailPage() {
  ...
  return (
    <div style={{
      ...
      {/* Status Bar */}
      <div style={{
        padding: "10px 20px 0", display: "flex", justifyContent: "space-between",
        fontSize: 12, fontWeight: 500, color: "#FFF", flexShrink: 0, zIndex: 30,
      }}>
        <span>9:41</span>
      ...
      {/* Header */}
      <div style={{
        padding: "10px 20px 12px", display: "flex", justifyContent: "space-between",
      ...
      <div className="hide-scrollbar" style={{ flex: 1, overflowY: "auto", WebkitOverflowScrolling: "touch" }}>
        ...
        <div style={{ padding: "16px 20px 0", animation: "fadeUp 0.4s ease 0.15s both" }}>
          ...
          }}>Reactions ({ARTWORK.totalReactions.toLocaleString()})</div>
          ...
          <div style={{
            ...
            {comments.length > 3 && (
              <button onClick={() => setShowAllComments(!showAllComments)} style={{
                ...
                color: "rgba(193,71,111,0.8)", cursor: "pointer", fontFamily: "'DM Sans', sans-serif",
              }}>
        ...
        {/* Related Artworks */}
        <div style={{ padding: "28px 0 100px", animation: "fadeUp 0.4s ease 0.3s both" }}>
          <div style={{
            ...
            <span style={{
              fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.4)",
              letterSpacing: "0.06em", textTransform: "uppercase",
            }}>Also in {ARTWORK.exhibition}</span>
          ...
          <div className="hide-scrollbar" style={{
            ...
            padding: "0 20px 4px", WebkitOverflowScrolling: "touch",
          }}>
        ...
        {[
          ...
          <button key={tab.id} style={{
            ...
            {tab.special ? (
              ...
              <span style={{ fontSize: 22, opacity: 0.45 }}>{tab.icon}</span>
            )}
            <span style={{
